...
1. Clone the repository: `git clone https://github.com/Dasarichandrashekar08/PersonalPortfolio.git`
2. Navigate to the project directory: `cd chandrashekarPortfolio`
